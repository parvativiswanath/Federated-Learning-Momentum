        ...
        try:
            ...
            while True:
                if ser.in_waiting > 0:
                    ...
                    #line = "Water Level:100, Moisture Percentage:37, Light Intensity: 875, Temperature:28, Humidity: 78"
                    time.sleep(2) 
            ...
            # Print status
                ...
                if prediction is not None:
                    ...
                    if prediction[2] > 0:
                        ...
                        #alert.send_alert()
                        send_alert.send_rover2_alert("alert","alert")
                        #subprocess.run(["python","send_alert.py"], check=True)
                        print(status + "\n")
                        print('Alert sent!\n')
